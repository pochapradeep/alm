...
//	private static final Logger logger = Logger.getLogger(JazzRootServicesHelper.class.getName());
	  ...
	  private static final Logger logger = LoggerFactory.getLogger(JazzRootServicesHelper.class);
	...
	public static void main(String args[]) throws RootServicesException{
		new JazzRootServicesHelper("https://34.209.145.222:9443/ccm/rootservices", "http://open-services.net/ns/cm#");
