       ...
       extends AbstractResource
{
	...
	public void setExistingURI(String existingURI) {
    ...
    @OslcDescription("External Link (reference: Dublin Core) or often a single line summary of the resource represented as rich text in XHTML content.")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcPropertyDefinition(CmConstants.RTC_CUSTOM_NAMESPACE + "external_link")
    @OslcTitle("External Link")
    @OslcValueType(ValueType.XMLLiteral)
